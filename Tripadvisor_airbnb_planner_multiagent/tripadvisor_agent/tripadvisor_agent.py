...
def create_tripadvisor_agent() -> LlmAgent:
    ...
    mcp_python = os.path.join(base_dir, 'tripadvisor-mcp-server-main', '.venv', 'Scripts', 'python.exe')
    mcp_server_script = os.path.join(base_dir, 'tripadvisor-mcp-server-main', 'server.py')
